...
export function DishModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
      <div className="bg-[#1A1D24] border border-[#222631] rounded-2xl max-w-lg w-full p-5 sm:p-6 shadow-2xl my-8">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-[#222631] pb-3.5 mb-4">
          <h3 className="text-lg font-bold text-white flex items-center gap-2">
            <Sparkles className="w-5 h-5 text-cheezious-yellow" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            ...
            <div className="sm:col-span-2 space-y-1">
              <label className="text-xs font-semibold text-cheezious-textLight">
                Dish Name *
              </label>
              <input
                type="text"
                ...
                className="w-full bg-[#111317] text-white text-xs sm:text-sm px-3.5 py-2 rounded-xl border border-[#222631] focus:border-cheezious-yellow focus:outline-none focus:ring-1 focus:ring-cheezious-yellow"
                required
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full bg-[#111317] text-white text-xs sm:text-sm px-3.5 py-2 rounded-xl border border-[#222631] focus:border-cheezious-yellow focus:outline-none"
              >
                {categories.map((cat) => (
            ...
            <div className="sm:col-span-2 space-y-1">
              ...
              <input
                ...
                className="w-full bg-[#111317] text-white text-xs px-3.5 py-2 rounded-xl border border-[#222631] focus:border-cheezious-yellow focus:outline-none"
                required
              />
            </div>

            {/* Image Preview & Stock Toggle */}
            <div className="sm:col-span-2 flex items-center justify-between gap-4 p-3 rounded-xl bg-[#111317] border border-[#222631]">
              <div className="flex items-center gap-3">
                <div className="relative w-12 h-12 rounded-lg overflow-hidden bg-neutral-800 border border-[#222631] shrink-0">
                  {imageUrl ? (
                    <Image
                      src={imageUrl}
                      alt="Preview"
                ...
                <div>
                  ...
                  <span className="text-[11px] text-cheezious-textMuted">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                  isAvailable ? "bg-emerald-500" : "bg-[#222631]"
                }`}
              >
                <span
          ...
          {/* Action Buttons */}
          <div className="pt-3 border-t border-[#222631] flex items-center justify-end gap-2.5">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 rounded-xl bg-[#222631] hover:bg-[#2D3342] text-white text-xs font-semibold transition-colors"
            >
              Cancel
            </button>
            <button
